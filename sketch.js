...
var score=0;
/*var vararray=[0,"jash",true,false]
vararray[0]=0;
vararray[1]="jash";
vararray[2]=true;
vararray[3]=false;*/
...
function setup() {
  ...
  trex = createSprite(50,height-27,20,50);
  ...
  gameOver = createSprite(width/2,height-250);
  ...
  invisibleGround = createSprite(width/2,height-27,width,10);
...
function draw() {
  ...
  background(160);
  fill("black");
  text("Score: "+ score,width-140,height-190);
